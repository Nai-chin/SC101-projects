...
This program prepare a python dict 'name_data' for babygraphics.py using.
The keys of name_data dict are names of baby. Values are also in dict type,
key: year, value: rank of that year, for example, {'2010','28'}.
"""
